-- Migration: Cap Working Capital Percentage in Health Score Calculation
-- Date: 2025-12-23
-- Issue: GHA health score showing 580 instead of 100
-- Root Cause: working_capital_percentage was 4904% due to negative amount_over_90_days values
--             The health score formula didn't cap this value at 0-100%
--
-- The formula was: COALESCE(working_capital.working_capital_percentage, 100) * 0.1
-- With working_capital_percentage = 4904, this contributed 490 points instead of max 10
--
-- Fix: Cap working_capital_percentage at 0-100 in health score calculation
--
-- To Execute: Run this SQL in Supabase Dashboard > SQL Editor

-- Drop and recreate client_health_summary with capped Working Capital
...
SELECT
  ...
  -- Note: working_capital_percentage is stored raw but CAPPED in health_score calculation
  ...
  -- FIX: Cap all percentage inputs at 0-100 to prevent overflow
  (
    ...
    -- Working Capital: 10% weight (CAPPED at 0-100, default 100 if no data)
